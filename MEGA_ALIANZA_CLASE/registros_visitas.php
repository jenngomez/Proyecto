                        ...
                        <table class="table">
                            ...
                            <tbody style="color:black">
                                ...
                                if (isset($_GET['btns']) && isset($_GET['Buscar'])) {
                                    ...
                                    $query = "SELECT*FROM Formato_visitas WHERE id_Formato_visitas LIKE '$Buscar' or Nombre_empleado LIKE '$Buscar' or Nombre_comercial LIKE '$Buscar'";
                                        ...
                                        while ($guardar = mysqli_fetch_array($consulta)) { ?>
                                            <tr>
                                                ...
                                                <td style="color:black">
                                                    <?php echo mb_strtoupper($guardar[8]); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo mb_strtoupper($guardar[11]); ?>
                                                </td>
                                                <td>
                                                    <img src=" <?php echo $guardar[13]; ?> " width="200" alt="">
                                                </td>

                                                <td><a href="generarpdfvisitas.php?nombre_empleado=<?php echo $guardar[5]?>&ruta=<?php echo $guardar[6] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
